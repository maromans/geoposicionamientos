...
for _, row in df.iterrows():
    ...
    folium.CircleMarker(
        ...
        tooltip=tooltip_text  # <--- esto hace que aparezca al pasar el mouse
    ).add_to(mapa)
...
# Guardar el mapa
mapa.save("../output/mapa_con_marcadores_coloreados_y_tooltip.html")

print("Mapa guardado en 'mapa_con_marcadores_coloreados_y_tooltip.html'")
